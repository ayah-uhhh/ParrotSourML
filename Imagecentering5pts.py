...
for key in flat:
    if '_startPos_x' in key:
        ...
        for n in range(0, 5):
            for i in range(0, 10):
                for j in range(0, 10):
                    # n is picture number, i is cluster of air craft, j is the individual aircraft
                    key = f"{n}_groups_{i}_{j}_startPos_x"
                    try:
    ...
    if '_startPos_y' in key:
        ...
        for n in range(0, 5):
            for i in range(0, 10):
                for j in range(0, 10):
                    # n is picture number, i is cluster of air craft, j is the individual aircraft
                    key = f"{n}_groups_{i}_{j}_startPos_y"
                    try:
...
file_path = os.path.join(
    '\\Users\\ayaha\\OneDrive\\Documents\\ParrotSour\\TrainingData\\5', 'Y.txt')
