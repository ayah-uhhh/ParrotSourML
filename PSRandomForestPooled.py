...
if __name__ == '__main__':
    ...
    results = [pool.apply_async(psrf.randomforest, args=([False, x, 240, False, False, False]))
               for x in range(10, 25)]

    # Also try 14,15,16,19 as these have historically been the lowest error rates
    results.extend([pool.apply_async(
        psrf.randomforest, args=([False, x, 240, False, False, False])) for x in [14, 15, 16, 19]])
